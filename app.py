...
# -*- coding: utf-8 -*-
"""
Severe HFRS Risk Prediction Web Tool
=====================================
Web-based prototype for early prediction of severe hemorrhagic fever
with renal syndrome (HFRS) using the final random forest model.

Usage: streamlit run app_hfrs.py
"""
...
with col2:
    dd = st.number_input('D-dimer (ng/mL)', min_value=0.0, max_value=10000.0, value=2033.1, step=50.0)
...
with col3:
    ...
    urine = st.number_input('24-h urine output (mL)', min_value=0.0, max_value=5000.0, value=570.0, step=50.0)
...
if st.button('Predict', type='primary'):
    ...
    # 参考方案: 大画布 + text_rotation=0 + subplots_adjust手动调边距
...
st.markdown(
    ...
    '<b>Disclaimer:</b> This tool uses a RF model and nine routinely available clinical variables '
    'at admission to provide an individualized estimate of severe HFRS risk for early clinical '
    'decision support; it is not intended to replace professional medical judgment.</p>',
    unsafe_allow_html=True
)
